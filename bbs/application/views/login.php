...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title>登录 - S51创业·个人主页</title>
  <base href="<?php echo site_url();?>"/>
  <link rel="stylesheet" href="css/oschina2011.css">
  <link rel="stylesheet" href="css/thickbox.css"> 
  <link rel="stylesheet" href="css/osc-popup.css"> 
...
<div class="MainForm" id="login_page">	
  <form id="frm_login" action="user/check_login" method="POST" style="float:left; width:620px;">
    <h2>登录个人主页，如果尚未加入的请点击<a href="user/reg">注册新会员</a></h2>
